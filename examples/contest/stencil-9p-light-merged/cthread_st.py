...
# Computation
#-------------------------------------------------------------------------------
mem0 = CoramMemory(idx=0, datawidth=8*DSIZE, size=SIZE, length=3, scattergather=False) # source
mem_d0 = CoramMemory(idx=4, datawidth=8*DSIZE, size=SIZE) # destination
