...
initial begin
  ...
  iochannel_write_cthread_pointer_read_stream_coramiochannel_0(mem_offset, 0);
  
  nclk();
  $display("write dma_size");
  iochannel_write_cthread_pointer_read_stream_coramiochannel_0(dma_size, 0);
  
  nclk();
  $display("write data_size");
  iochannel_write_cthread_pointer_read_stream_coramiochannel_0(data_size, 0);
  
  nclk();
  iochannel_read_cthread_pointer_read_stream_coramiochannel_0(read_val, 0);
  nclk();
