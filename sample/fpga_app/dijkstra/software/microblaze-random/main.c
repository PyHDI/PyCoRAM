...
void dijkstra()
{
  ...
  Uint start = *(volatile Uint*)(MMAP_MEMORY + 0x0);
  Uint goal = *(volatile Uint*)(MMAP_MEMORY + 0x4);

  Uint nedges = *(volatile Uint*)(MMAP_MEMORY + 0x8);
  Uint nnodes = *(volatile Uint*)(MMAP_MEMORY + 0xC);
